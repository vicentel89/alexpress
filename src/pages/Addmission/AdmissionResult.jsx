...
function AdmissionResult({ values }) {
  ...
  return (
    <>
      <CopyButton resultRef={aResultRef} />
      <div ref={aResultRef}>
        <h1>
          {" "}
        ...
        <h2>ANÁLISIS </h2>
        <p>
          RECIBO PACIENTE {term} EN REGULARES CONDICIONES GENERALES. SE
          ENCUENTRA PACIENTE ACTIVO REACTIVO, SIN DÉFICIT APARENTE, NI CRISIS
          NEONATALES,{" "}
          {values.hasOxygen ? (
          ...
          INGRESA LA UNIDAD PARA VIGILANCIA ESTRICTA Y MANEJO, PRONÓSTICO SUJETO
          A EVOLUCIÓN CLÍNICA. SE EXPLICA A LOS PADRES QUIENES REFIEREN ENTENDER
          Y ACEPTAR.
        </p>
        <h2> PLAN </h2>
